...
# ==============================
# Theme + CSS (ĐÃ CHỈNH SỬA PHẦN HEADER CSS)
# ==============================
...
/* CSS MỚI CHO HEADER THEO YÊU CẦU */
#custom-header {
    display: flex;
    align-items: center;
    justify-content: flex-start; /* Logo ở trái */
    padding: 10px 0;
    background-color: #fcfcf5; /* Màu nền trắng/kem nhẹ */
    border-bottom: 3px solid #b8860b; /* Đường viền nhẹ mô phỏng màu gold */
    margin-bottom: 20px;
}
#header-logo {
    font-size: 50px; /* Tương đối to */
    color: #b8860b; /* Màu gold nhẹ */
    margin-right: 20px;
    margin-left: 20px; /* Thêm margin trái cho logo */
}
#header-text {
    flex-grow: 1;
    text-align: center;
    color: #b8860b; /* Màu gold nhẹ cho chữ */
}
#header-line1 {
    font-size: 12px;
    font-weight: 500;
...
/* Ẩn phần Streamlit main-header-bar để custom header không bị đè */
...
# --- HÀM HEADER MỚI (UX/UI) ---
def st_header():
    """Tạo header theo yêu cầu: Logo Ngân Hàng, 3 dòng chữ ở giữa."""
    # Dùng icon Placeholder vì không có file logo, có thể thay bằng thẻ <img> nếu có file.
    # Ví dụ: logo_html = '<img src="path/to/your/logo.png" alt="Logo NHNN" style="height: 50px; margin-right: 20px;">'
    logo_html = '<div id="header-logo">🏛️</div>' # Icon tòa nhà mô phỏng logo ngân hàng

    header_html = f"""
    <div id="custom-header">
        {logo_html}
        <div id="header-text">
            <div id="header-line1">Dashboard tổng hợp phân tích báo cáo</div>
            <div id="header-line2">NGÂN HÀNG NHÀ NƯỚC VIỆT NAM</div>
            <div id="header-line3">DBND</div>
        </div>
    </div>
    """
...
# ==============================
# GEMINI CHATBOT LOGIC (GIỮ NGUYÊN)
# ==============================
...
# --- GỌI HÀM HEADER MỚI THAY CHO st.title() CŨ ---
st_header() 
# ----------------------------------------------------
...
        st.dataframe(df_act_full.drop(columns=["legal_reference"]), use_container_width=True)
