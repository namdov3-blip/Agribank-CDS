...
/* --- CHỈNH SỬA CHO MENU TABS (ĐOẠN MỚI) --- */
/* Căn giữa các tabs bằng cách điều chỉnh flexbox của container */
[data-testid="stTabs"] > div {
    justify-content: center !important; 
    gap: 20px; /* Thêm khoảng cách giữa các tab nếu cần */
}
/* Phóng to font chữ của từng tab */
button[data-testid^="stTab"] {
    font-size: 1.1rem !important; /* Phóng to cỡ chữ */
...
        st.dataframe(freq_tbl, use_container_width=True, heig
